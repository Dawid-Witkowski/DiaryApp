...
internal class WriteViewModel @Inject constructor(
    ...
    private fun fetchSelectedDiary() {
        if (uiState.selectedDiaryId != null) {
            viewModelScope.launch {
                com.example.mongo.repository.MongoDB.getSelectedDiary(diaryId = ObjectId.invoke(uiState.selectedDiaryId!!))
                    .catch {
    ...
    private suspend fun insertDiary(
        ...
        val result = com.example.mongo.repository.MongoDB.insertDiary(diary = diary.apply {
    ...
    private suspend fun updateDiary(
        ...
        val result = com.example.mongo.repository.MongoDB.updateDiary(diary = diary.apply {
    ...
    internal fun deleteDiary(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            if (uiState.selectedDiaryId != null) {
                val result = com.example.mongo.repository.MongoDB.deleteDiary(id = ObjectId.invoke(uiState.selectedDiaryId!!))
                if (result is RequestState.Success) {
                    withContext(Dispatchers.Main) {
    ...
    internal fun addImage(image: Uri, imageType: String) {
